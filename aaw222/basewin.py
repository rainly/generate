...
class BaseMainWind ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText7 = wx.StaticText( self, wx.ID_ANY, u"起始金额", wx.DefaultPosition, wx.Size( 80,-1 ), 0 )
		self.m_staticText7.Wrap( -1 )
		bSizer3.Add( self.m_staticText7, 0, wx.ALL, 5 )
		
		self.m_staticText8 = wx.StaticText( self, wx.ID_ANY, u"赢退金额", wx.DefaultPosition, wx.Size( 80,-1 ), 0 )
		self.m_staticText8.Wrap( -1 )
		bSizer3.Add( self.m_staticText8, 0, wx.ALL, 5 )
		
		self.m_staticText9 = wx.StaticText( self, wx.ID_ANY, u"输进金额", wx.DefaultPosition, wx.DefaultSize, 0 )
