...
class BaseMainWind ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"北京赛车", pos = wx.DefaultPosition, size = wx.Size( 500,430 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText4 = wx.StaticText( self, wx.ID_ANY, u"道（道序号,道序号，...）", wx.DefaultPosition, wx.DefaultSize, 0 )
