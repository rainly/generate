...
class BaseMainWind ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"北京赛车(两面盘)", pos = wx.DefaultPosition, size = wx.Size( 500,470 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"购买规则（大小单双=小  换行）", wx.DefaultPosition, wx.DefaultSize, 0 )
