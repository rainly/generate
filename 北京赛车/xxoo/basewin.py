...
class BaseMainWind ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"北京赛车(数字盘)", pos = wx.DefaultPosition, size = wx.Size( 500,550 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_radioBtn4 = wx.RadioButton( self, wx.ID_ANY, u"北京赛车", wx.DefaultPosition, wx.DefaultSize, wx.RB_GROUP )
		bSizer4.Add( self.m_radioBtn4, 0, wx.ALL, 5 )
		
		self.m_radioBtn5 = wx.RadioButton( self, wx.ID_ANY, u"幸运飞艇", wx.DefaultPosition, wx.DefaultSize, 0 )
