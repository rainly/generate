            ...
            while self.stopped == False:
                try:
                    ...
                    if MyKey2[tclass2] == "4单": #4单
                        ...
                        Last_Award_Issue_Buy = ""
                        '''
                        if MyKey2[tclass3] == "3双":
                            self.logprint("***检测是否下注*** 上轮：3双 ==> 本轮：4单 ==>不购买")
                            Last_Award_Issue_Buy = ""                        
                        elif MyKey2[tclass3] == "4单":
                            self.logprint("***检测是否下注*** 上轮：4单 ==> 本轮：4单 ==>不购买")
                            Last_Award_Issue_Buy = ""                        
                        else:
                        ...
                        if MyKey2[tclass3] == "3单":
                            ...
                            self.logprint("***检测是否下注*** 上轮：3双/4单 ==>本轮：4双 ==>购买3单")
                            Last_Award_Issue_Buy = "3单"  
                        '''
                        self.logprint("***检测是否下注***4双 ==>不购买")
                        Last_Award_Issue_Buy = ""
                        ...
                        '''
                        if MyKey2[tclass3] == "3双":
                            self.logprint("***检测是否下注*** 上轮：3双 ==> 本轮：3双 ==>不购买")
                            Last_Award_Issue_Buy = ""                        
                        elif MyKey2[tclass3] == "4单":
                            self.logprint("***检测是否下注*** 上轮：4单 ==> 本轮：3双 ==>不购买")
                            Last_Award_Issue_Buy = ""                        
                        else:
                            self.logprint("***检测是否下注*** 上轮：3单/4双 ==>本轮：3双 ==>购买4单")
                            Last_Award_Issue_Buy = "4单" 
                        ...
                        if MyKey2[tclass3] == "3单":
                            ...
                            self.logprint("***检测是否下注*** 上轮：3双/4单 ==>本轮：3单 ==>购买4双")
                            Last_Award_Issue_Buy = "4双" 
                        '''
                        self.logprint("***检测是否下注***3单 ==>不购买") 
                        Last_Award_Issue_Buy = ""                        
                    else:
